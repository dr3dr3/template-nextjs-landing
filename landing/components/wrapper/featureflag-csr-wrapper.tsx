...
export default function ClientSideFeatureFlagWrapper({
  children, 
  feature,
  showDisabled
}: {
  ...
  return (
    <>
      {!isClient && (
          <div>
            <svg aria-hidden="true" className="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-primary-500 dark:fill-secondary-500" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
