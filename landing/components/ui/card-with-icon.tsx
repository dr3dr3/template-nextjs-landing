...
export default function Card(props: PropsWithChildren<Card>) {
  return (
    <div className='mx-auto max-w-lg p-10 text-neutral-900 dark:text-neutral-100 text-center bg-neutral-50 dark:bg-neutral-950 rounded-xl shadow'>
        <div className="mx-auto w-20 h-20 p-4 mb-4 -mt-20 text-neutral-50 dark:text-neutral-950 bg-primary dark:bg-secondary rounded-full border-4 border-neutral-50 dark:border-neutral-950">
            {props.children}
        </div>
