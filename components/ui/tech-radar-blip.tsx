...
export function Blip(props: IBlip) {
  ...
  return (
    <Popover className="relative">
      ...
      <Popover.Panel className={clsx('absolute z-10 bg-neutral-50 border-primary-700 dark:bg-neutral-950 dark:border-secondary-400 border-2 rounded-md', {
        ...
        <div className="w-32 h-8 text-xs text-center px-2 pt-2 pb-1">
          {label}
        </div>
      </Popover.Panel>
    </Popover>
